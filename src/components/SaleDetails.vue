...
<template>
    <div class="border-t border-gray-200 space-y-6 py-6">
        ...
        <ul role="list"
            class="mt-6 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium texty-gray-500">

            <li v-for="item in sale.items" class="flex py-6 gap-4">

                <img :src="item.image" :alt="'Imagen de ' + item.name" class="h-24 w-24 flex-none rounded-lg">

                <div class="flex-auto space-y-2 mt-0 ">
