...
const submitHandler = async (data) => {
    const { image, ...values } = data // saca la imagen del objeto que envía el formulario
            ...
            <div class="mt-10 p-10 w-full 2xl:w-2/4">
                ...
                <FormKit type="form" submit-label="Añadir Producto"
                    ...
                    <FormKit type="number" label="Disponibles" name="availability" placeholder="Cantidad disponible"
                        validation="required" :validation-messages="{ required: 'La cantidad es obligatoria' }" min="1"
